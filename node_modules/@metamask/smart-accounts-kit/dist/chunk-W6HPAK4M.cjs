...
var allowedMethodsBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createAllowedMethodsTerms.call(void 0, { selectors: parsedSelectors });
  const {
...
var allowedTargetsBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createAllowedTargetsTerms.call(void 0, { targets });
  const {
...
var argsEqualityCheckBuilder = (environment, config) => {
  ...
  return {
    ...
    terms: _delegationcore.createArgsEqualityCheckTerms.call(void 0, { args }),
    args: "0x00"
  };
};
...
var blockNumberBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createBlockNumberTerms.call(void 0, { afterThreshold, beforeThreshold });
  const {
...
var deployedBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createDeployedTerms.call(void 0, { contractAddress, salt, bytecode });
  const {
...
var erc20TransferAmountBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createERC20TransferAmountTerms.call(void 0, { tokenAddress, maxAmount });
  const {
...
var erc721TransferBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createERC721TransferTerms.call(void 0, { tokenAddress, tokenId });
  const {
...
var exactCalldataBatchBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createExactCalldataBatchTerms.call(void 0, { executions });
  const {
...
var exactExecutionBatchBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createExactExecutionBatchTerms.call(void 0, { executions });
  const {
...
var exactExecutionBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createExactExecutionTerms.call(void 0, { execution });
  const {
...
var idBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createIdTerms.call(void 0, { id: idBigInt });
  const {
...
var limitedCallsBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createLimitedCallsTerms.call(void 0, { limit });
  const {
...
var multiTokenPeriodBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createMultiTokenPeriodTerms.call(void 0, {
...
var nativeTokenPaymentBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createNativeTokenPaymentTerms.call(void 0, { recipient, amount });
  const {
...
var nativeTokenTransferAmountBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createNativeTokenTransferAmountTerms.call(void 0, { maxAmount });
  const {
...
var ownershipTransferBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createOwnershipTransferTerms.call(void 0, { contractAddress });
  const {
...
var redeemerBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createRedeemerTerms.call(void 0, { redeemers });
  const {
...
var specificActionERC20TransferBatchBuilder = (environment, config) => {
  ...
  const terms = _delegationcore.createSpecificActionERC20TransferBatchTerms.call(void 0, {
    tokenAddress,
    recipient,
    amount,
    target,
...
function createFunctionCallCaveatBuilder(environment, config) {
  ...
  const valueLteConfig = _nullishCoalesce(config.valueLte, () => ( { maxValue: 0n }));
...
var toDelegationStruct = (delegation) => {
  ...
  return {
    ...
    authority: _nullishCoalesce(delegation.authority, () => ( _delegationcore.ROOT_AUTHORITY)),
    caveats,
    salt,
...
var encodeDelegations = (delegations) => {
  ...
  if (_viem.isHex.call(void 0, delegations)) {
    return delegations;
  }
  throw new Error(
...
var encodeDelegation = (delegation) => {
  ...
  return _delegationcore.encodeDelegation.call(void 0, delegationStruct);
};
var decodeDelegations = (delegations) => {
  ...
  if (_viem.isHex.call(void 0, delegations)) {
    return _delegationcore.decodeDelegations.call(void 0, delegations).map(toDelegation);
  }
  throw new Error(
    "Invalid delegations - must be an array of delegations or a hex string"
  );
...
var decodeDelegation = (encoded) => {
  return toDelegation(_delegationcore.decodeDelegation.call(void 0, encoded));
};
