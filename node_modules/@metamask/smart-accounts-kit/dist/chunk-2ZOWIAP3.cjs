...
async function sendTransactionWithDelegationAction(client, args) {
  ...
  const chainId = _optionalChain([client, 'access', _3 => _3.chain, 'optionalAccess', _4 => _4.id]);
  if (!chainId) {
...
async function sendUserOperationWithDelegationAction(client, parameters) {
  ...
  if (parameters.dependencies) {
    ...
    const chainId = _optionalChain([publicClient, 'access', _7 => _7.chain, 'optionalAccess', _8 => _8.id]);
    if (!chainId) {
      throw new Error("Chain ID is not set");
    }
