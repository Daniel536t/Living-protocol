...
var getCounterfactualAccountData = async ({
  ...
  switch (implementation) {
    case "Hybrid" /* Hybrid */: {
      ...
      initcode = _chunkJKVSTPECcjs.encode.call(void 0, { eoaOwner: owner, p256Owners });
      break;
    }
    case "MultiSig" /* MultiSig */: {
      ...
      initcode = _chunkJKVSTPECcjs.encode2.call(void 0, { owners, threshold });
      break;
    }
  ...
  const proxyCreationCode = _chunkJKVSTPECcjs.encodeProxyCreationCode.call(void 0, {
  ...
  const factoryData = _chunkJKVSTPECcjs.encode3.call(void 0, proxyCreationCode, salt);
  return {
    factoryData,
    address
  };
...
var processDelegatedCall = (call) => {
  ...
  const callAsExecution = _chunkW6HPAK4Mcjs.createExecution.call(void 0, { target, value, callData });
  if (!permissionContext) {
    return callAsExecution;
  }
  const encodedPermissionsContext = _chunkW6HPAK4Mcjs.encodeDelegations.call(void 0, permissionContext);
  const redeemCalldata = _viem.encodeFunctionData.call(void 0, {
    ...
    args: [
      ...
      _chunkW6HPAK4Mcjs.encodeExecutionCalldatas.call(void 0, [[callAsExecution]])
    ]
  });
  return _chunkW6HPAK4Mcjs.createExecution.call(void 0, {
...
var encodeCalls = (calls) => {
  if (calls.length === 1) {
    ...
    if (call && !isDelegatedCall(call)) {
      ...
      const execution = _chunkW6HPAK4Mcjs.createExecution.call(void 0, { target, value, callData });
      return _chunkJKVSTPECcjs.encode4.call(void 0, { execution });
    }
  }
  const executions = calls.map((call) => {
    ...
    const { to: target, value, data: callData } = call;
    return _chunkW6HPAK4Mcjs.createExecution.call(void 0, { target, value, callData });
  });
  ...
  return _chunkJKVSTPECcjs.encode5.call(void 0, { mode, executions });
};
var encodeCallsForCaller = async (caller, calls) => {
  if (calls.length === 1) {
    const call = calls[0];
    if (_optionalChain([call, 'optionalAccess', _ => _.to]) === caller && !isDelegatedCall(call)) {
...
//# sourceMappingURL=chunk-DCI2AN4N.cjs.map