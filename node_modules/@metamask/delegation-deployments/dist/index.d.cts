...
declare const CHAIN_ID: {
    ...
    sonic: number;
    unichain: number;
    megaEthMainnet: number;
    celo: number;
    ronin: number;
    tempoMainnet: number;
    citreaMainnet: number;
    mantleMainnet: number;
    katanaMainnet: number;
    intuitionMainnet: number;
    bscTestnet: number;
    ...
    celoSepolia: number;
    roninSaigon: number;
    tempoModeratoTestnet: number;
    mantleSepolia: number;
    katanaBokuto: number;
    intuitionTestnet: number;
    lineaGoerli: number;
};
